  ...
  <div class="app-container">
    ...
    <div class="mainTable">
      ...
      >
        ...
        <el-table-column align="center" label="发送账号" width="95">
        ...
        <el-table-column label="消息内容" width="200" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.infoContent }}</span>
          </template>
        </el-table-column>
        <el-table-column label="在线与否" width="200" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.online }}</span>
          </template>
        </el-table-column>
        <el-table-column label="私聊群聊" width="200" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.singleMessage }}</span>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
...
<script>
import { getAllMessage } from "@/api/log";
